...
<head>
    ...
    var vResult = false;
    	...
    	function doSubmit(){
    		...
    		//手机号校验
    		/*
    		if (!${user.mobile}.equle($("#mobile").val())) {
    			doVerify();
    		}*/
...
<form id="form" name="form" action="${basePath }xfgl/user_add.action" method="post">
    <div class="p_d_1">
        <div class="p_d_1_1">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td><s:textarea name="user.address" cols="75" rows="3"/></td>
        </tr>
        <tr>
